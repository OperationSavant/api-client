      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="query" className="space-y-4">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <Label htmlFor="graphql-query" className="text-sm">GraphQL Query/Mutation</Label>
              <Button
                onClick={formatQuery}
                size="sm"
                variant="outline"
                className="flex items-center gap-2"
                disabled={!graphqlConfig.query.trim()}
              >
  ...
  users {
    ...
    email
        ...
        <TabsContent value="variables" className="space-y-4">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <Label htmlFor="graphql-variables" className="text-sm">Variables (JSON)</Label>
...
Example:
{
  ...
  "name": "John Doe"
        ...
        <TabsContent value="settings" className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="operation-name" className="text-sm">Operation Name (Optional)</Label>
            <Input
              id="operation-name"
            ...
            <p className="text-xs text-muted-foreground">
              Specify which operation to execute when the query contains multiple operations
            </p>
          </div>
        </TabsContent>
      </Tabs>
