	...
	return (
		<div className='space-y-4'>
			<div className='space-y-2'>
				...
				<Textarea id='bearer-token' placeholder='Enter bearer token' value={auth.token} onChange={handleTokenChange} className='min-h-[100px] resize-none' />
			</div>

			<div className='space-y-2'>
				<Label htmlFor='bearer-prefix'>Prefix</Label>
				<Input id='bearer-prefix' type='text' placeholder='Bearer' value={auth.prefix} onChange={handlePrefixChange} />
			</div>
