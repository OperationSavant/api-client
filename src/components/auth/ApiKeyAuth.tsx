	...
	return (
		<div className='space-y-4'>
			<div className='space-y-2'>
				...
				<Input id='apikey-key' type='text' placeholder='Enter API key name' value={auth.key} onChange={handleKeyChange} />
			</div>

			<div className='space-y-2'>
				<Label htmlFor='apikey-value'>Value</Label>
				<Input id='apikey-value' type='text' placeholder='Enter API key value' value={auth.value} onChange={handleValueChange} />
			</div>
